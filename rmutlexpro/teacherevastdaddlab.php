          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-list"></i> ประเมิน (ปฏิบัติ)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
...
<!-- Tab panes -->
<form class="form-horizontal" action="evaaddstdlab.php?studentid=<?php echo $st_row1['student_id'];?>&teacherid=<?php echo $_SESSION['teacher_id'];?>&lessionid=<?php echo $st_row1['lession_id'];?>" id="form_submit" method="post">
