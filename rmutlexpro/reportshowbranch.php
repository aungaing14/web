                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:45%;text-align:center">ชื่อ - สกุล</td>
                                        <td style="width:25%;text-align:center">ชั้นปี</td>
                                        <td style="width:20%;text-align:center">View</td>                                  
                                    </tr>
...
$strSQLa = "SELECT * FROM student WHERE branch_id='$id1'";
...
else
{
    ...
    $Num_Pages = (int)$Num_Pages;
                                    ...
                                    $i='0';
                                    $strSQL = "SELECT * FROM student WHERE branch_id='$branch_id' ORDER BY student_id ASC LIMIT $Page_Start , $Per_Page ";
                                        ...
                                        <td style="text-align:center"><a href='reportshowstdbranch.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
