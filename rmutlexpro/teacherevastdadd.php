          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-list"></i> ประเมิน (ทฤษฎี)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
...
<div class="table-responsive">
                 ...
                 <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label style="font-weight: normal;text-align:left" class="control-label" value='<?php echo $st_row1['subject_name'];?>'><?php echo $st_row1['subject_name'];?>
                               ...
                               <div class="form-group">
                                ...
                                <label style="font-weight: normal;text-align:left" class="control-label" value='<?php echo $st_row1['lession_week'];?>'><?php echo $st_row1['lession_week'];?>
...
<td style="text-align:center"><?php $c=$value1/10; echo $c;?><input type=hidden name="question_id[]" value="<?php echo $id;?>"></td>
