...
<!-- Tab panes -->
<form class="form-horizontal" action="evaaddstdtrainer.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>&lessionid=<?php echo $st_row1['lession_id'];?>" id="form_submit" method="post">
...
<td style="text-align:center"><?php $bb=$value1/10; echo $bb?><input type=hidden name="question_id[]" value="<?php echo $id;?>"></td>
