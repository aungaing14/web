                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold">
                                        <td style="width:25%;text-align:center">รหัสสถานศึกษา</td>
                                        <td style="width:55%;text-align:center">ชื่อสถานศึกษา</td>
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align:center"><a href='ceducationshow.php?education_id=<?php echo $nti['education_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
