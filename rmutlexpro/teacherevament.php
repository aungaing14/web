...
<div class="tab-pane active" id="stdpro">
      ...
      <div><br></div>
                           <form class="form-horizontal" action="teacherevamentsave.php?studentid=<?php echo $studentid?>&teacherid=<?php echo $teacherid?>" method="post" id="form_submit">

<div align="right"> 
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("teacherevapic.php?studentid=<?php echo $studentid;?>&teacherid=<?php echo $teacherid;?>")'><i class="icon-file-alt"></i> แนบรูปภาพ</button>  
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                     <?php
                                            include("connect.php");
$strSQLa = "SELECT * FROM student WHERE student_id='$studentid'";
...
$cc=$ntia['year_id'];
                                            ...
                                            $sqltitle="SELECT * FROM  lession WHERE term_id='$cc' AND year_id='$dd' AND student_id='$studentid' ";
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="teacherevamentsave" style="height: 150;" required="required"> </textarea>
