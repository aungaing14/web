...
$query = "ALTER TABLE `lessionevalab` DROP q$subquestion_id ";
mysql_query($query) or die(mysql_error());
$sql_result6=mysql_query($query);

$querya = "ALTER TABLE `lessionevatrlab` DROP q$subquestion_id ";
mysql_query($querya) or die(mysql_error());
$sql_resulta=mysql_query($querya);


$query7 = "ALTER TABLE `lessionevamentlab` DROP q$subquestion_id ";
mysql_query($query7) or die(mysql_error());
$sql_result7=mysql_query($query7);

$queryb = "ALTER TABLE `lessionevamenttrainerlab` DROP q$subquestion_id ";
...
$strSQL = "DELETE FROM subquestionlab ";
