          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> กำหนดนักศึกษาเทศก์</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
                  ...
                  <table class="table table-hover table-bordered" id="ajax_course_table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:28%;text-align:center">สถานศึกษา</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-center"><input type="radio" name='student_id[]' value="<?php echo $nti['student_id']?>"></td>
