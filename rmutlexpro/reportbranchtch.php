                                ...
                                <tbody>
                                    ...
                                    $strSQL = "SELECT * FROM branch ";
                                        ...
                                        <td style="text-align:center;">
                                            <?php
                                                $branch1 ="SELECT * FROM teacher WHERE branch_id=$branch_id";
                                        ...
                                        <td style="text-align:center"><a href='reportteacher.php?branch_id=<?php echo $nti['branch_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
