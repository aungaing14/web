...
$row=mysql_query("SELECT * FROM lessionlab WHERE student_id=$student");
...
<!-- Tab panes -->
<form class="form-horizontal" action="evaaddstdtraineryearlab.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>" id="form_submit" method="post">
