...
$row=mysql_query("SELECT * FROM lession WHERE student_id=$student");
...
<!-- Tab panes -->
<form class="form-horizontal" action="evaaddstdtraineryear.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>" id="form_submit" method="post">
