                    ...
                    <!-- Left / Top Side -->
               		<div class="col-lg-12">
                    	<div class="panel panel-teal">
							...
							<form class="form-horizontal" action="abstractadd.php?student_id=<?php echo $student_id;?>"  id="form_submit" method="post">
								<div class="form-horizontal"> 
									<div class="col-md-12"> 
                                    	<br>
                                  		<div class="col-md-12">
                            				<textarea id="com1" class="form-control" name="abstractname" rows="10"></textarea>
                            			</div>
            							<div class="col-sm-12">
                                   			<hr>
                                     	</div>
