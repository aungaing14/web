          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-list"></i> แก้ไขการประเมิน</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
...
<!-- Tab panes -->
<form class="form-horizontal" action="evastdedit.php?studentid=<?php echo $st_row1['student_id'];?>&teacherid=<?php echo $_SESSION['teacher_id'];?>&lessionid=<?php echo $st_row1['lession_id'];?>" id="form_submit" method="post">
<div class="table-responsive">
                 ...
                 <div class="form-group">
                           ...
                           <div class="form-group">
                                ...
                                <?php
                                    $strSQL = "SELECT * FROM lessioneva WHERE lessioneva_id = '$lession' ";
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="date_eva" value='<?php echo $nti['lessioneva_date'];?>'>    
                                <?php }?>
                                </div>
                            </div>
...
$strSQL1 = "SELECT * FROM lessioneva WHERE lessioneva_id=$lession ";
$objQuery1 = mysql_query($strSQL1);
while ($nti1=mysql_fetch_array($objQuery1)){ 

$ans=$nti1[$id1];
$strSQL4 = "SELECT * FROM lessionevament WHERE lessionevament_id=$lession ";
