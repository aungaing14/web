                  ...
                  <table class="table table-hover table-bordered" id="ajax_course_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><a href='adminteachershowstd.php?student_id=<?php echo $nti['student_id'];?>?>'  data-toggle="tooltip" data-placement="top" data-original-title="แสดงข้อมูล"><i class=" icon-search" style="color:#00ccff"></i></a></td>
                        <td class="text-center"><a href='adminstdregisremove.php?student_id=<?php echo $nti['student_id'];?>&year_id=<?php echo $nti['year_id'];?>&term_id=<?php echo $nti['term_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>
                        </tr>
                      <?php }?> 
