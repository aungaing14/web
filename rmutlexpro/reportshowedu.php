          ...
          <div class="form-horizontal">
              ...
              <div class="panel-body">                  
                ...
                <div align="right">
                                ...
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("reportedu.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
...
<?php   
                                    ...
                                    $strSQL = "SELECT * FROM education ";
                                        ...
                                        echo "ชื่อสถานศึกษา : ",$nti['education_name'], "<hr>";
                                        ?>
...
$strSQLb = "SELECT * FROM student WHERE branch_id='$branch_id'";
...
$strSQLa = "SELECT * FROM student WHERE edu_id='$education_id' AND  branch_id='$id1'";
...
else
{
    ...
    $Num_Pages = (int)$Num_Pages;
                                    ...
                                    $i='0';
                                    $strSQL = "SELECT * FROM student WHERE edu_id='$education_id' AND  branch_id='$id1' ORDER BY student_id ASC LIMIT $Page_Start , $Per_Page";
                                        $objQuery = mysql_query($strSQL);?>
                                        <?php
                                        ...
                                        <td style="text-align:center"><a href='reportshowstdedu.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
...
if($Prev_Page)
{
    echo " <a href='$_SERVER[SCRIPT_NAME]?branch_id=$id1&education_id=$education_id&Page=$Prev_Page'><< Back</a> ";
}

for($i=1; $i<=$Num_Pages; $i++){
    if($i != $Page)
    {
        echo "[ <a href='$_SERVER[SCRIPT_NAME]?branch_id=$id1&education_id=$education_id&Page=$i'>$i</a> ]";
    }
    else
    {
        echo "<b> $i </b>";
...
if($Page!=$Num_Pages)
{
    echo " <a href ='$_SERVER[SCRIPT_NAME]?branch_id=$id1&education_id=$education_id&Page=$Next_Page'>Next>></a> ";
}
