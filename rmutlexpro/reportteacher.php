                    ...
                    <div align="right">
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="10"><i class=" icon-user"></i><strong> สรุปรายชื่ออาจารย์นิเทศก์ปฏิบัติประสบการณ์วิชาชีพครู</strong></td>
                                    </tr>
                                    ...
                                    <?php   
                                    $i='0';
                                    $strSQL = "SELECT * FROM teacher WHERE branch_id=$branch_id";
                                        ...
                                        <td style="text-align:left"><?php $title_id=$nti['title_id']; $a="SELECT * FROM title WHERE title_id='$title_id'"; $objQuerya = mysql_query($a); $ntia=mysql_fetch_array($objQuerya); echo $ntia['title_name'];?><?php echo $nti['teacher_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['teacher_lname'];?></td>
                                        ...
                                        <td style="text-align:center"><a href='reportshowteacher.php?teacher_id=<?php echo $nti['teacher_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
