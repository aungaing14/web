...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> ข้อมูลแผนก/สาขาวิชา</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
      ...
      <div><br></div>
            <div class="form-group">
                                ...
                                ?>
                                 <label style="font-weight: normal" class="control-label" value='<?php echo $nti['educationpart_id'];?>'><?php echo $nti['educationpart_id'];?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-5">ชื่อแผนก/สาขาวิชา : </label>
                              <?php
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-5">หัวหน้าแผนก : </label>
                              <?php
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-5">สถานศึกษา : </label>
                              <?php
