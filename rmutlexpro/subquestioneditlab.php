...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขรายการประเมิน(ปฏิบัติ)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
             <form class="form-horizontal" action="subevaeditsavelab.php" method="post" id="form_submit">

                            <div class="form-group">
                                <label class="control-label col-sm-4">หัวข้อรายการประเมินที่ : </label>
                                <?php
                                    

                                    $strSQL = "SELECT * FROM subquestionlab  WHERE subquestion_id=$subquestion_id";
                                ...
                                ?>
                                <input class="form-control"  readonly required name="qfrm_id" value='<?php echo $nti['qfrm_id'];?>'>    
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT a.qfrm_id,b.qfrm_id,b.qfrm_name FROM subquestionlab a INNER JOIN questionlab_frm b ON a.qfrm_id=b.qfrm_id WHERE subquestion_id=$subquestion_id";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-4">
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){   
                                ?>
                                <input class="form-control"  readonly required name="qfrm_name" value='<?php echo $nti['qfrm_name'];?>'>    
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control"  name="subquestion_id" readonly required value='<?php echo $nti['subquestion_id'];?>'>    
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control"  name="subquestion_name" value='<?php echo $nti['subquestion_name'];?>'>    
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control"  name="subquestion_score" value='<?php echo $nti['subquestion_score'];?>'>    
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal" onclick='location.replace("adminevalutionlab.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
                    </form>
