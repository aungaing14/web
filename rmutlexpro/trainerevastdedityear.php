...
$rowa=mysql_query("SELECT * FROM lessionevatr WHERE lessionevatr_id=$lession");
$st_row12=mysql_fetch_array($rowa);
$std=$st_row12['lessionevatr_student'];

$row=mysql_query("SELECT * FROM lession WHERE student_id=$std");
...
<!-- Tab panes -->
<form class="form-horizontal" action="evastdedittr.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>&lessionid=<?php echo $lession?>" id="form_submit" method="post">
                 ...
                 <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <?php
                                    $strSQL = "SELECT * FROM lessionevatr WHERE lessionevatr_id = '$lession' ";
...
$strSQL1 = "SELECT * FROM lessionevatr WHERE lessionevatr_id=$lession ";
$objQuery1 = mysql_query($strSQL1);
while ($nti1=mysql_fetch_array($objQuery1)){ 

$ans=$nti1[$id1];
$strSQL4 = "SELECT * FROM lessionevamenttrainer WHERE lessionevamenttrainer_id=$lession ";
...
<td style="text-align:center"><?php echo $a=$value1/10;?><input type=hidden name="question_id[]" value="<?php echo $id;?>"></td>
