          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> ข้อมูลอาจารย์พี่เลี้ยง</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("admintrainer.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
           ...
           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">ชื่อ-สกุล : </label>
                                    ...
                                    <?php
                                        ...
                                        $strSQL = "SELECT a.trainer_id,a.trainer_name,a.trainer_lname,b.title_name FROM trainer a INNER JOIN title b ON a.title_id=b.title_id WHERE trainer_id='$trainer_id' ";
                                        $objQuery = mysql_query($strSQL) or die(mysql_error());
                                    ?>
                                    <div class="col-sm-3">
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT a.trainer_id,b.education_id,b.education_name  FROM trainer a INNER JOIN education b ON b.education_id=a.education_id WHERE trainer_id='$trainer_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-3">
                                <?php
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT a.trainer_id,b.educationpart_id,b.educationpart_name  FROM trainer a INNER JOIN educationpart b ON b.educationpart_id=a.educationpart_id WHERE trainer_id='$trainer_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-4">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['trainer_password'];?>'><?php echo $nti['trainer_password'];?>
