...
<body>
        ...
        <div id="pop_box4">
            <div id="pop_content"> 
                <div id="pop_header">
                    <i class="icon-edit"></i> บันทึกรายสัปดาห์
                </div>
                <form class="form-horizontal" action="regisrequire.php" method="post" id="form_submit">
                        <div id="pop_body">
                            <div class="form-group">
                                <center><label class="control-label col-sm-12" style="text-align:center;">ได้มีการเพิ่มบันทึกรายสัปดาห์ไว้ก่อนหน้านี้แล้ว</label></center>
                                
                                
                            </div>
                            <div class="form-group">
                            	<center><a href="stdteach.php" class=" icon-arrow-left"> กลับสู่หน้าหลัก</a></center>
