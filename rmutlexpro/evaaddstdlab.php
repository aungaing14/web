...
$sql_insert2="INSERT INTO `lessionevamentlab` (`lessionevament_id`,`lessionevament_student`,`lessionevament_teacher`) VALUES ('".$lessionid."','".$stdid."','".$teacherid."');";
...
$sql_insert1="INSERT INTO `lessionevalab` (`lessioneva_id`,`term_id`,`lessioneva_student`,`lessioneva_date`,`lessioneva_teacher`) VALUES ('".$lessionid."','".$term."','".$stdid."','".$date."','".$teacherid."');";
...
$sql = "SELECT subquestion_score FROM subquestionlab WHERE subquestion_id='$id'";
	...
	while($rs1 = mysql_fetch_array($result)){
		...
		$strSQLa = "UPDATE lessionevalab SET lessioneva_score = '$ans' WHERE lessioneva_id ='$lessionid'";
