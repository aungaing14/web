...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> ข้อมูลสถานศึกษา</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("cadminedu.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
      ...
      <div><br></div>
            <div class="form-group">
                                ...
                                ?>
                                 <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_id'];?>'><?php echo $nti['education_id'];?>
                            ...
                            <div class="form-group">
                              ...
                              <?php
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_code'];?>'><?php echo $nti['education_code'];?>

                                <?php }?>
                                    </label>
                                </div>
                                <label class="control-label col-sm-2">หมู่ : </label>
                               <?php
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_moo'];?>'><?php echo $nti['education_moo'];?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">ซอย : </label>
                              <?php
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_soi'];?>'><?php echo $nti['education_soi'];?>
                               ...
                               <?php
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_road'];?>'><?php echo $nti['education_road'];?>
                            ...
                            <div class="form-group">
                               ...
                               <?php
                                    ...
                                    $strSQL = "SELECT a.education_district,b.DISTRICT_ID,b.DISTRICT_NAME FROM education a INNER JOIN district b ON a.education_district=b.DISTRICT_ID WHERE education_id='$education_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-3">
                                <?php
                               ...
                               <?php
                                    ...
                                    $strSQL = "SELECT a.education_amphur,b.AMPHUR_ID,b.AMPHUR_NAME FROM education a INNER JOIN amphur b ON a.education_amphur=b.AMPHUR_ID WHERE education_id='$education_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-3">
                                <?php
                            ...
                            <div class="form-group">
                               ...
                               <?php                                    
                                    ...
                                    $strSQL = "SELECT a.education_province,b.PROVINCE_ID,b.PROVINCE_NAME FROM education a INNER JOIN province b ON a.education_province=b.PROVINCE_ID WHERE education_id='$education_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-3">
                                <?php
                                ...
                                <label class="control-label col-sm-2">รหัสไปรษนี : </label>
                               <?php
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['education_post'];?>'><?php echo $nti['education_post'];?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">เว็บไซต์ : </label>
                               <?php
