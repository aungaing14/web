                  ...
                  <table class="table table-bordered" id="ajax_course_table">
                    ...
                    <?php $strSQL = "SELECT * FROM lession WHERE student_id='$id' ";
                      ...
                      <tr>
                        ...
                        <td class="text-center"><a href='teacherevastdadd.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ประเมิน"><i class=" icon-edit" style="color:#ffcc00"></i></a></td>
                        <td class="text-center"><a href='teacherevamentopen.php?eva=evanmnt&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="เรียกดู"><i class=" icon-search" style="color:#00ccff"></i></a></td>
                        </tr>
...
<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label style="font-weight: normal;text-align:left" class="control-label" value='<?php echo $st_row2['subject_name'];?>'><?php echo $st_row2['subject_name'];?>
