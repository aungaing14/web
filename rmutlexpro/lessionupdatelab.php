...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขกำหนดการสอน (ปฏิบัติ)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="lessioneditlab.php?lessionid=<?php echo $_GET["lession_id"];?>" id="form_submit" method="post" enctype="multipart/form-data">
 
                            <div class="form-group">
                                <label class="control-label col-sm-3">สัปดาห์ที่ : </label>
                                <?php
                                    $strSQL = "SELECT * FROM lessionlab WHERE lession_id = '$lession_id' ";
                                ...
                                <div class="col-sm-1">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="lession_week" value='<?php echo $nti['lession_week'];?>'>    
                                <?php }?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="subject_id" value='<?php echo $nti['subject_id'];?>'>    
                                <?php }?>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="subject_name" value='<?php echo $nti['subject_name'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="lession_name" value='<?php echo $nti['lession_name'];?>'>    
                                <?php }?>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="lession_class" value='<?php echo $nti['lession_class'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="lession_time" value='<?php echo $nti['lession_time'];?>'>    
                                <?php }?>
                                </div>
                                <label class="control-label col-sm-2">วันที่สอน : </label>
                                <?php
                                    $strSQL = "SELECT * FROM lessionlab WHERE lession_id = '$lession_id' ";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="lession_date" value='<?php echo $nti['lession_date'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal"  onclick='location.replace("stdteachlab.php")'><i class="icon-remove"></i> ปิด</button>
                        </div>
                    </form>
