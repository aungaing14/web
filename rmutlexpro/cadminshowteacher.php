...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> ข้อมูลอาจารย์นิเทศก์</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("cadminteacher.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
      ...
      <div class="form-group">
              <?php
                            $strSQL = "SELECT * FROM images WHERE id_image = '$teacher_id' ";
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT * FROM teacher WHERE teacher_id='$teacher_id' ";
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">คำนำหน้าชื่อ : </label>
                                    ...
                                    <?php
                                        ...
                                        $strSQL = "SELECT a.teacher_id,b.title_name FROM teacher a INNER JOIN title b ON a.title_id=b.title_id WHERE teacher_id='$teacher_id' ";
                                        $objQuery = mysql_query($strSQL) or die(mysql_error());
                                    ?>
                                    <div class="col-sm-3">
                                        <?php
                                            while ($nti=mysql_fetch_array($objQuery)){  
                                        ?>
                                         <label style="font-weight: normal" class="control-label" value='<?php echo $nti['title_id'];?>'><?php echo $nti['title_name'];?>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                 ...
                                 <label style="font-weight: normal" class="control-label" value='<?php echo $nti['teacher_id'];?>'><?php echo $nti['teacher_name'];?>
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                  <label style="font-weight: normal" class="control-label" value='<?php echo $nti['teacher_id'];?>'><?php echo $nti['teacher_lname'];?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">คณะ : </label>
                                 <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.faculty_name FROM teacher a INNER JOIN faculty b ON a.faculty_id=b.faculty_id WHERE teacher_id='$teacher_id' ";
                                ...
                                ?>
                                <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['faculty_id'];?>'><?php echo $nti1['faculty_name'];?>
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.course_name FROM teacher a INNER JOIN course b ON a.course_id=b.course_id WHERE teacher_id='$teacher_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <div class="col-sm-4">
                                    ...
                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                    ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['course_id'];?>'><?php echo $nti1['course_name'];?>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.branch_name FROM teacher a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE teacher_id='$teacher_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <?php
                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                    ?>
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['branch_id'];?>'><?php echo $nti1['branch_name'];?>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                   <label style="font-weight: normal" class="control-label" value='<?php echo $nti['teacher_password'];?>'><?php echo $nti['teacher_password'];?>
