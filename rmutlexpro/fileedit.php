...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขเอกสาร</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="fileeditsave.php?file_id=<?php echo $_GET["file_id"];?>" id="form_submit" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                    <input class="form-control" name="file_name" value='<?php echo $nti['file_name'];?>'>    
                                <?php }?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input class="form-control" name="file_date">    
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal"  onclick='location.replace("cfile.php")'><i class="icon-remove"></i> ปิด</button>
                        </div>
                    </form>
