...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> รายชื่อนักศึกษานิเทศก์</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                 <div align="right">
      ...
      <div><br></div>
            <div class="form-group">
                                <label class="control-label col-sm-3">ชื่อ - สกุล อาจารย์นิเทศก์  : </label>
                                <?php
                                ...
                                <label style="font-weight: normal" class="control-label" ><?php $title=$nti['title_id']; $strSQL1 = "SELECT * FROM title WHERE title_id='$title' "; $objQuery1 = mysql_query($strSQL1); $nti1=mysql_fetch_array($objQuery1); echo $nti1['title_name'];
                                     ?><?php echo $nti['teacher_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['teacher_lname'];?></label> 
                                <?php }?>   
                                    
                                </div>
                            </div>
                            <br>
<form method="post" action="teachermultiupdate.php?teacher_id=<?php echo $teacher_id;?>">
                  ...
                  <table class="table table-hover table-bordered" id="ajax_course_table">
                    ...
                    <tbody>
                      <?php 
                        $strSQL1 = "SELECT * FROM teacher  WHERE teacher_id=$teacher_id ";
                        $objQuery1 = mysql_query($strSQL1);
                        $nti1=mysql_fetch_array($objQuery1);
                        $branch=$nti1['branch_id'];
                        $teacher=$nti1['teacher_id'];
                        
                        

                        $strSQL = "SELECT a.student_id,a.student_name,a.student_lname,a.edu_id,a.teacher_id,b.branch_id,b.branch_name,a.term_id,a.year_id,d.education_id,d.education_name FROM student a INNER JOIN branch b ON a.branch_id=b.branch_id INNER JOIN class c ON a.class_id=c.class_id INNER JOIN education d ON a.edu_id=d.education_id WHERE a.teacher_id='$teacher' AND a.term_id!='10' AND a.year_id!='100' AND a.branch_id=$branch ";
                        $objQuery = mysql_query($strSQL); ?>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><a href='cadminteachershowstd.php?teacher_id=<?php echo $teacher;?>&student_id=<?php echo $nti['student_id'];?>?>'  data-toggle="tooltip" data-placement="top" data-original-title="แสดงข้อมูล"><i class=" icon-search" style="color:#00ccff"></i></a></td>
