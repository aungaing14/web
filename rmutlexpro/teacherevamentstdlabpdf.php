...
<table width="704" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="200" align="center"><span class="style" style="font-weight: bold;font-size:11pt;">(ปฏิบัติ)</span></td>
...
<?php }?>
 ...
 <?php 
  $strSQL = "SELECT * FROM lessionlab WHERE student_id = ".$_GET['student_id']." ";
    $objQuery = mysql_query($strSQL);?>
  <?php
...
$i='0';
$sum='0';
  $strSQL = "SELECT * FROM lessionlab WHERE term_id='$cc' AND year_id='$bb' AND student_id = ".$_GET['student_id']." ";
    $objQuery = mysql_query($strSQL);?>
  <?php
   while ($nti=mysql_fetch_array($objQuery)){  
   $sum=$sum+$nti['lession_score'];  

   $strSQL1 = "SELECT * FROM question WHERE question_id = '2' ";
...
$strSQLb = "SELECT * FROM lessionlab WHERE term_id='$cc' AND year_id='$dd' AND student_id='$bb'";
$objQueryb = mysql_query($strSQLb);
$ntib=mysql_fetch_array($objQueryb);
$cc=$ntib['lession_id'];


  $strSQL = "SELECT * FROM lessionevalab  WHERE lessioneva_id =$cc AND lessioneva_student = ".$_GET['student_id']." ";
    $objQuery = mysql_query($strSQL);
...
$a=$a+$score;
  ...
  $strSQL = "SELECT * FROM question WHERE question_id = '2' ";
    $objQuery = mysql_query($strSQL);?>
  <?php
  $nti=mysql_fetch_array($objQuery);
    ?>  
