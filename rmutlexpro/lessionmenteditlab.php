...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> บันทึกรายสัปดาห์ (ปฏิบัติ)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="lessionupdatesavelab.php?lessionid=<?php echo $_GET["lession_id"];?>" method="post" id="form_submit">
                    
                            <div class="form-group">
                                <label class="control-label col-sm-3">วันที่ : </label>
                                <?php
                                    $strSQL = "SELECT * FROM lessionmentlab WHERE lessionment_id = '$lession_id' ";
                                ...
                                <div class="col-sm-3">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_date" value='<?php echo $nti['lessionment_date'];?>'>    
                                    <?php }?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_1" value='<?php echo $nti['lessionment_1'];?>'>    
                                    <?php }?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_2" value='<?php echo $nti['lessionment_2'];?>'>    
                                    <?php }?>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_3" value='<?php echo $nti['lessionment_3'];?>'>    
                                    <?php }?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_4" value='<?php echo $nti['lessionment_4'];?>'>    
                                    <?php }?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                    ?>
                                        <input class="form-control"  name="lessionment_5" value='<?php echo $nti['lessionment_5'];?>'>    
                                    <?php }?>
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal" onclick='location.replace("stdteachlab.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>
                        </div>
                    </form>
