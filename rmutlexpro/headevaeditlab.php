...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขหัวข้อรายการประเมิน(ปฏิบัติ)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="headevaeditsavelab.php" method="post" id="form_submit">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT * FROM questionlab_frm WHERE qfrm_id='$qfrm_id' ";
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control"  name="qfrm_name" value='<?php echo $nti['qfrm_name'];?>'>    
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal"onclick='location.replace("adminevalutionlab.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  </button>
                        </div>
                    </form>
