...
<div class="tab-pane active" id="stdpro">
      ...
      <div><br></div>
            <form class="form-horizontal" action="lessionupdatesave.php?lessionid=<?php echo $_GET["lession_id"];?>" method="post" id="form_submit">
                    
                            <div class="form-group">
                                <label class="control-label col-sm-3">วันที่ : </label>
                                <?php
                                    $strSQL = "SELECT * FROM lessionment WHERE lessionment_id = '$lession_id' ";
