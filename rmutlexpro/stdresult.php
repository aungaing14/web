                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold">
                                        ...
                                        <td style="width:35%;text-align:center">วันที่ประเมิน</td>
...
while ($ntib=mysql_fetch_array($objQueryb)) {
  $cc=$ntib['lession_id'];
                        ...
                        $strSQL = "SELECT * FROM lessioneva WHERE lessioneva_id ='$cc' AND lessioneva_student ='".$_SESSION['student_id']."' ";
                      ...
                      ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center"><?php echo $nti['lessioneva_date'];?></td>
                                        <td style="text-align:left"><?php $lessionid=$nti['lessioneva_id']; 
                        $strSQL1 = "SELECT * FROM lessioneva WHERE lessioneva_id ='$cc' ";
                        $objQuery1 = mysql_query($strSQL1);
                        $nti1=mysql_fetch_array($objQuery1); 
                        $teacherid=$nti1['lessioneva_teacher']; 
                        ...
                        echo $nti2['teacher_lname'];
                         ?></td>
                                        <td style="text-align:center"><a href="stdresultshow.php?stdevashow=show&lessioneva_id=<?php echo $nti['lessioneva_id'];?>" data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class="icon-search" style="color:#00ccff"></i></a></td>
...
while ($ntib=mysql_fetch_array($objQueryb)) {
  $cc=$ntib['lession_id'];
                        ...
                        $strSQL = "SELECT * FROM lessionevatr WHERE lessionevatr_id =$cc AND lessionevatr_student ='".$_SESSION['student_id']."' ";
                        $objQuery = mysql_query($strSQL);?>
                      <?php
                        while ($nti=mysql_fetch_array($objQuery)){  
                      ...
                      ?>
                                    <tr>
                                        <td style="text-align:center"><?php echo $i;?></td>
                                        <td style="text-align:center"><?php echo $nti['lessionevatr_date'];?></td>
                                        <td style="text-align:left"><?php $lessionid=$nti['lessionevatr_id']; 
                        $strSQL1 = "SELECT * FROM lessionevatr WHERE lessionevatr_id ='$lessionid' ";
                        $objQuery1 = mysql_query($strSQL1);
                        $nti1=mysql_fetch_array($objQuery1); 
                        $trainerid=$nti1['lessionevatr_trainer']; 

                        $strSQL2 = "SELECT * FROM trainer WHERE trainer_id ='$trainerid' ";
                        $objQuery2 = mysql_query($strSQL2);
                        $nti2=mysql_fetch_array($objQuery2); 
                        echo $nti2['trainer_name'],'&nbsp;','&nbsp;','&nbsp;','&nbsp;';
                        echo $nti2['trainer_lname'];
                         ?></td>
                                        <td style="text-align:center"><a href="stdresultshowtr.php?stdevashow=show&lessionevatr_id=<?php echo $nti['lessionevatr_id'];?>" data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class="icon-search" style="color:#00ccff"></i></a></td>
