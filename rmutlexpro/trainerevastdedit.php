...
<!-- Tab panes -->
<form class="form-horizontal" action="evastdedittr.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>&lessionid=<?php echo $st_row1['lession_id'];?>" id="form_submit" method="post">
