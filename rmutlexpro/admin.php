     ...
     <div id="pop_background2"></div> 
        <div id="pop_box2">
            <div id="pop_content2">
                ...
                <form class="form-horizontal" action="adminupdate.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                ...
                                ?>
                                    <input class="form-control" readonly required name="txtadmin_id" value='<?php echo $nti['admin_id'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL = "SELECT a.admin_id,b.title_name FROM admin a INNER JOIN title b ON a.title_id=b.title_id WHERE admin_id = '".$_SESSION['admin_id']."' ";
                            ...
                            ?>
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtadmin_name" value='<?php echo $nti['admin_name'];?>'>    
                                <?php }?>
                                </div>
                            <?php
                                    $strSQL = "SELECT * FROM admin WHERE admin_id = '".$_SESSION['admin_id']."' ";
                            ...
                            ?>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtadmin_lname" value='<?php echo $nti['admin_lname'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">คณะ : </label>
                                 <?php
                                    $strSQL1 = "SELECT a.admin_id,b.faculty_name FROM admin a INNER JOIN faculty b ON a.faculty_id=b.faculty_id WHERE admin_id = '".$_SESSION['admin_id']."' ";
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.admin_id,b.course_name FROM admin a INNER JOIN course b ON a.course_id=b.course_id WHERE admin_id = '".$_SESSION['admin_id']."' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.admin_id,b.branch_name FROM admin a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE admin_id = '".$_SESSION['admin_id']."' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
        ...
        <div id="pop_box4">
            <div id="pop_content4"> 
                ...
                <form class="form-horizontal" action="admineditpass.php?admin_id=<?php echo $_SESSION['admin_id'];?>" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
       ...
       <div id="pop_background5"></div>
        <div id="pop_box5">
            <div id="pop_content5">
                ...
                <form name="form1" method="post" action="uploadpicadmin.php?admin_id=<?php echo $_SESSION['admin_id'];?>"  enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 panel-body">
                        ...
                        <ul class="list-table" style="padding-left: 5px;">
                            <li>
                                <?php
                            $strSQL = "SELECT * FROM images WHERE id_image = '".$_SESSION['admin_id']."' ";
                            $objQuery = mysql_query($strSQL) or die(mysql_error());
                                            ...
                                            <div class="form-horizontal"> 
                                                <div class="col-md-12"> 
                                                    <div class="panel-collapse pull-right out">
                                                        <button type="button" class="btn btn-primary btn-lg" id="adminedit"><i class="icon-pencil"></i> แก้ไขข้อมูล
                                                        </button>
                                                ...
                                                <div class="col-md-12"> 
                                                        ...
                                                        ?>
                                                            <div class="col-sm-7">
                                                                <?php
                                                                    while ($nti=mysql_fetch_array($objQuery)){  
                                                                ?>
                                                                <label style="font-weight: normal" class="control-label" value='<?php echo $nti['admin_id'];?>'><?php echo $nti['admin_id'];?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php
                                                            $strSQL1 = "SELECT a.admin_id,b.title_name FROM admin a INNER JOIN title b ON a.title_id=b.title_id WHERE admin_id = '".$_SESSION['admin_id']."' ";
                                                            $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <?php
                                                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                                            ?>
                                                            <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['faculty_name'];?>'><?php echo $nti1['faculty_name'];?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <?php
                                                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                                            ?>
                                                            <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['course_name'];?>'><?php echo $nti1['course_name'];?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <?php
                                                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                                            ?>
                                                            <label style="font-weight: normal" class="control-label" value='<?php echo $nti1['branch_name'];?>'><?php echo $nti1['branch_name'];?>
