...
<?php   
                                ...
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:60%;text-align:center">หลักสูตร</td>
                                    ...
                                    $strSQL = "SELECT * FROM branch ";
                                        ...
                                        $branch_id=$nti['branch_id'];
                                        $i=$i+'1';  
                                        ?>
                                        <td style="text-align:center"><?php echo $i;?></td>
                                   
                                        <td style="text-align:left"><?php echo $nti['branch_name'];?></td>

                                        <td style="text-align:center;">
                                            <?php
                                                $branch1 ="SELECT * FROM student WHERE branch_id=$branch_id AND edu_id=$education_id";
                                        ...
                                        <td style="text-align:center"><a href='reportshowedu.php?branch_id=<?php echo $nti['branch_id'];?>&education_id=<?php echo $ntia['edu_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
