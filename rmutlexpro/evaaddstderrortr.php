                ...
                <form class="form-horizontal" action="regisrequire.php" method="post" id="form_submit">
                        <div id="pop_body">
                            <div class="form-group">
                                <center><label class="control-label col-sm-12" style="text-align:center;">ได้มีการประเมินรายการนี้เรียบร้อยแล้ว</label></center>
                                
                                
                            </div>
                            <div class="form-group">
                            	<center><a href="trainereva.php" class=" icon-arrow-left"> กลับสู่หน้าหลัก</a></center>
