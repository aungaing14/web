...
$lession_week=$_POST['lession_week'];
	...
	while($rs = mysql_fetch_array($result))
			{
	$sql1 = "INSERT INTO lession (`lession_id`,`year_id`, `term_id`, `student_id`) VALUES ('$lessionid'
	,'".$rs['term_id']."','".$rs['year_id']."','$student_id')";
	mysql_query($sql1) or die(mysql_error());

	}

	$sql5 = "UPDATE lession SET subject_id='$subject_id',subject_name='$subject_name',lession_name='$lession_name',lession_class='$lession_class',lession_time='$lession_time',lession_week='$lession_week',lession_date='$lession_date',lession_file='$newname' WHERE lession_id= '$lessionid' AND student_id='".$_SESSION['student_id']."'";
