...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> ข้อมูลผู้ใช้งาน</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("adminuser.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
      ...
      <div class="form-group">
              <?php
                            $strSQL = "SELECT * FROM images WHERE id_image = '$admin_id' ";
                            ...
                            ?>
                                <div  class="img-resize"><img  id="img" class="img-thumbnail" src="img/<?=$Picture;?>" alt="รูปผู้ใช้งาน" >
                                </div>
                             <?php }?>              
        </div>
        <div class="form-group">
            ...
            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">ชื่อ-สกุล : </label>
                                    ...
                                    <?php
                                        ...
                                        $strSQL = "SELECT a.admin_id,a.admin_name,a.admin_lname,b.title_name FROM admin a INNER JOIN title b ON a.title_id=b.title_id WHERE admin_id='$admin_id' ";
                                        $objQuery = mysql_query($strSQL) or die(mysql_error());
                                    ?>
                                    <div class="col-sm-3">
                                        <?php
                                    ...
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['admin_name'];?>'><?php echo $nti['admin_name'];?>

                                  
                                    </label> 
                                    <label style="font-weight: normal" class="control-label" value='<?php echo $nti['admin_lname'];?>'><?php echo $nti['admin_lname'];?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">คณะ : </label>
                                 <?php
                                    $strSQL = "SELECT a.admin_id,b.faculty_name FROM admin a INNER JOIN faculty b ON a.faculty_id=b.faculty_id WHERE admin_id='$admin_id' ";
                                    $objQuery = mysql_query($strSQL) or die(mysql_error());
                                ?>
                                <div class="col-sm-3">
                                <?php
                                ...
                                <?php
                                    $strSQL = "SELECT a.admin_id,b.course_name FROM admin a INNER JOIN course b ON a.course_id=b.course_id WHERE admin_id='$admin_id' ";
                                    $objQuery = mysql_query($strSQL) or die(mysql_error());
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.admin_id,b.branch_name FROM admin a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE admin_id='$admin_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                                            
                                ?>
                                <div class="col-sm-5">
                                 <?php
                                    while ($nti=mysql_fetch_array($objQuery1)){  
                                ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <label style="font-weight: normal" class="control-label" value='<?php echo $nti['admin_password'];?>'><?php echo $nti['admin_password'];?>
