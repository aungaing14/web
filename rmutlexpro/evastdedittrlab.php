...
$strSQLa = "UPDATE lessionevatrlab SET lessionevatr_score = '0',lessionevatr_date='$date_eva' WHERE lessionevatr_id ='$lessionid'";
...
$save=$_POST['nall'.$id];
 ...
 $strSQL = "UPDATE lessionevatrlab SET q$id = '$save' WHERE lessionevatr_id ='$lessionid'";
...
$sql = "SELECT subquestion_score FROM subquestionlab WHERE subquestion_id='$id'";
	...
	while($rs1 = mysql_fetch_array($result)){
		...
		$strSQLb = "UPDATE lessionevatrlab SET lessionevatr_score = '$ans' WHERE lessionevatr_id ='$lessionid'";
...
$strSQL = "UPDATE lessionevamenttrainerlab SET q$id = '$ment' WHERE lessionevamenttrainer_id ='$lessionid'";
$objQuery = mysql_query($strSQL) or die(mysql_error());
