...
$rowa=mysql_query("SELECT * FROM lessionevatrlab WHERE lessionevatr_id=$lession");
$st_row12=mysql_fetch_array($rowa);
$std=$st_row12['lessionevatr_student'];

$row=mysql_query("SELECT * FROM lessionlab WHERE student_id=$std");
...
<!-- Tab panes -->
<form class="form-horizontal" action="evastdedittrlab.php?studentid=<?php echo $st_row1['student_id'];?>&trainerid=<?php echo $_SESSION['trainer_id'];?>&lessionid=<?php echo $lession?>" id="form_submit" method="post">
