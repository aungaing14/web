                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <?php   
                                    $i='0';
                                    $strSQL = "SELECT * FROM year WHERE year_id!='100' ";
                                        ...
                                        <td style="text-align:center"><?php echo $nti['year_name'];?></td>
                                         ...
                                         <td style="text-align:center;">
                                            <?php
                                                $branch1 ="SELECT * FROM studentsave WHERE year_id=$year_id";
                                        ...
                                        <td style="text-align:center"><a href='reportyearbr.php?year_id=<?php echo $nti['year_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
