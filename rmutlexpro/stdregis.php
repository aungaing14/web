        ...
        <div id="pop_box4">
          <div id="pop_content4">
              <div id="pop_header">
                ...
                <form class="form-horizontal" action="stdregisadd.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                ...
                                <?php
                                            include("connect.php");
                                            $sqltitle="SELECT * FROM year WHERE active='1'  ";
...
<?php   
    $strSQL10 = "SELECT * FROM termyear WHERE active='1'";
...
<img  id="img" class="img-thumbnail" src="images/regisopen.jpg" alt="โยธา" >
...
<div class="row">
              <div class="col-lg-12 panel-body">
                        <div align="right">
                            ...
                            <button type="button" class="btn btn-primary btn-lg" id="stdregis" style="background-color:#80bfff;border-color: #80bfff; color:#fff"><i class="icon-plus"></i> ลงทะเบียน</button>  
                        </div>
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="10"><i class=" icon-user"></i><strong> ผลการลงทะเบียน</strong></td>
                                    </tr>
                                    <input type="hidden" id="val1" value="0">
                                    <tr style="font-weight:bold;">
                                        <td style="width:40%;text-align:center">ปีการศึกษา</td>
                                        <td style="width:40%;text-align:center">ภาคเรียน</td>
                                        <td style="width:20%;text-align:center">ยกเลิกการลงทะเบียน</td>
                                                         
                                    </tr>
                                    
                                    <tr>
                                    <?php $strSQL = "SELECT a.student_id,a.year_id,a.term_id,b.year_id,b.year_name,c.termyear_id,c.termyear_name  FROM student a INNER JOIN year b ON a.year_id=b.year_id INNER JOIN termyear c ON a.term_id=c.termyear_id WHERE a.year_id!='100' AND a.term_id!='10' AND student_id ='".$_SESSION['student_id']."' ";
                                      ...
                                      ?>
                                        ...
                                        <td style="text-align:center"><a href='stdregiscancle.php?student_id=<?php echo $nti['student_id'];?>&yearid=<?php echo $nti['year_id'];?>&termid=<?php echo $nti['term_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>                 
                                    </tr>
                                   <?php }?> 
