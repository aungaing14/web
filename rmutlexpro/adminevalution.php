     ...
     <div id="pop_background"></div> 
        <div id="pop_box">
            <div id="pop_content">
                ...
                <form class="form-horizontal" action="adminheadevaadd.php" id="form_submit" method="post">
                        <div id="pop_body">
        ...
        <div id="pop_box4"> 
            <div id="pop_content4">
                ...
                <form class="form-horizontal" action="adminsubevaadd.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                <label class="control-label col-sm-4">หัวข้อรายการประเมิน : </label>
                                <div class="col-sm-7">
                                <?php
                                    include("connect.php");
                                    $sqltitle="SELECT * FROM question_frm ORDER BY qfrm_id ASC ";
...
<div align="right">
    ...
    <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("adminevalutionlab.php")'><i class="icon-file-alt"></i> แบบประเมินภาคปฏิบัติ</button>  
</div>
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แบบประเมินภาคทฤษฎี</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                  <div class="form-group">
...
<div class="table-responsive">
                      <table class="table table-bordered" id="ajax_course_table">
                        <thead>
<?php
$strSQLa = "SELECT * FROM question_frm ";
...
$strGroup = "SELECT * FROM question_frm  order by qfrm_id LIMIT $Page_Start , $Per_Page";
...
<td style="font-weight:bold;text-align:left" colspan="2" style="width:100%;"><?php echo $value;?>. <?php $strSQL = "SELECT * FROM question_frm WHERE qfrm_id=$value "; $objQuery = mysql_query($strSQL);?>
    <?php
        while ($nti=mysql_fetch_array($objQuery)){  
    ?> <?php echo $nti['qfrm_name'];?> <?php }?>  </td>

<td style="font-weight:bold;text-align:center" colspan="1" style="width:100%;"><?php $strSQL = "SELECT * FROM question_frm WHERE qfrm_id=$value "; $objQuery = mysql_query($strSQL);?>
    <?php
        while ($nti=mysql_fetch_array($objQuery)){  
...
?>
 ...
 <tr>
<?php $strSQL = "SELECT * FROM subquestion WHERE subquestion_id=$value1 "; $objQuery = mysql_query($strSQL);?>
    <?php
        while ($nti=mysql_fetch_array($objQuery)){  
    ?>
    ...
    <div class="tab-pane active" id="stdpro">
        <div class="panel-body">
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-list"></i> แก้ไขแบบประเมินภาคทฤษฎี</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
                  <div class="form-group">
...
<div class="table-responsive">
                      <table class="table table-bordered" id="ajax_course_table">
                        ...
                        <?php
                           ...
                           $strSQL = "SELECT * FROM question_frm";
                        ...
                        ?>
                            ...
                            <td style="text-align:center"><a href='headevaedit.php?qfrm_id=<?php echo $nti['qfrm_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class="icon-edit" style="color:#ffcc00"></i></a></td>
                            <td style="text-align:center"><a href='headevadelete.php?qfrm_id=<?php echo $nti['qfrm_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>
                          </tr>
                        <?php }?> 
...
<td style="font-weight:bold;text-align:left" colspan="5" style="width:100%;"><?php echo $value;?>. <?php $strSQL = "SELECT * FROM question_frm WHERE qfrm_id=$value "; $objQuery = mysql_query($strSQL);?>
    <?php
        while ($nti=mysql_fetch_array($objQuery)){  
    ?> <?php echo $nti['qfrm_name'];?> <?php }?>  </td> 
...
<td style="text-align:center"><a href='subquestionedit.php?subquestion_id=<?php echo $value1;?>' data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class="icon-edit" style="color:#ffcc00"></i></a></td>
<td style="text-align:center"><a href='subquestiondelete.php?subquestion_id=<?php echo $nti['subquestion_id'];?>&subquestion_score=<?php echo $nti['subquestion_score'];?>&qfrm_id=<?php echo $nti['qfrm_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>
