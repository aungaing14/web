        ...
        <div id="pop_box">
            <div id="pop_content">
                <div id="pop_header">
                            ...
                            <i class="icon-edit"></i> เพิ่มปีการศึกษา
                </div>
                <form class="form-horizontal" action="adminyearadd.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                <label class="control-label col-sm-5">ปีการศึกษา : </label>
                                <div class="col-sm-4">

                                    <input class="form-control" name="year_name" required="required">    
                                </div>
                            </div>
        ...
        <div id="pop_box4">
            <div id="pop_content4">
                <div id="pop_header">
                            ...
                            <i class="icon-edit"></i> เปิดลงทะเบียน
                </div>
                <form class="form-horizontal" action="adminyearactive.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                <label class="control-label col-sm-5">ปีการศึกษา : </label>
                                <div class="col-sm-4">
                                <?php
                                            include("connect.php");
                                            $sqltitle="SELECT * FROM year WHERE year_id!='100' ";
                                             $result=mysql_query($sqltitle);
                                           
                                ?>

                                    <select class="form-control" name="yearid" id="yearid" required="required">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-5">ภาคเรียน : </label>
                                <div class="col-sm-4">

                                    <select class="form-control" name="termid" id="termid"></select>    
                                </div>
                            </div>
...
<ul class="nav nav-tabs" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#yearpage" role="tab">ปีการศึกษา</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#regispage" role="tab">ลงทะเบียน</a>
  </li>
...
<div class="tab-content">
    <div class="tab-pane active" id="yearpage" role="tabpanel">
 <br>
                        <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff"><i class="icon-plus"></i> เพิ่มปีการศึกษา</button>
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="5"><i class=" icon-file"></i><strong> ปีการศึกษา/ภาคเรียน</strong></td>
                                    </tr>
                                    <input type="hidden" id="val1" value="0">
                                    <tr style="font-weight:bold">
                                       <td style="width:40%; text-align:center">ปีการศึกษา</td>
                                        <td style="width:35%; text-align:center">ลบ</td>
                    
                                    </tr>
                                    
                                    <tr>
                                        <?php   $strSQL = "SELECT * FROM year WHERE year_id!='100'";
                                        $objQuery = mysql_query($strSQL);?>
                                        <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                        ?>
                                        <td style="text-align:center"><?php echo $nti['year_name'];?></td>
                                      
                                    
                                        <td style="text-align:center"><a href='admindeleteyear.php?year_id=<?php echo $nti['year_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>                                  
                                    </tr> 
                                    <?php }?> 
                                </tbody>
                            </table>
   ...
   <div class="tab-pane" id="regispage" role="tabpanel">
       <div align="right">
                   <br>         
                               
                                <button type="button" class="btn btn-primary btn-lg" id="adduser1" style="background-color:#80bfff;border-color: #80bfff;; color:#fff"><i class=" icon-folder-open"></i> เปิดลงทะเบียน</button>
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold">
                                       <td style="width:40%; text-align:center">ปีการศึกษา</td>
                                        <td style="width:35%; text-align:center">ภาคเรียนการศึกษา</td>
                                        
                                        
                                        <td style="width:25%; text-align:center">ปิดการลงทะเบียน</td>                        
                                    </tr>
                                    
                                    <tr>
                                        <?php   $strSQL = "SELECT a.termyear_id,a.termyear_name,a.active,a.year_id,b.year_id,b.year_name FROM termyear a INNER JOIN year b ON a.year_id=b.year_id  WHERE a.active='1' ORDER BY a.termyear_id DESC ";
                                        $objQuery = mysql_query($strSQL);?>
                                        <?php
                                        while ($nti=mysql_fetch_array($objQuery)){  
                                        ?>
                                        <td style="text-align:center"><?php echo $nti['year_name'];?></td>
                                        <td style="text-align:center"><?php echo $nti['termyear_name'];?></td>
                                       
                                    
                                        <td style="text-align:center"><a href='adminyearclose.php?termyear_id=<?php echo $nti['termyear_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ยืนยัน"><i class=" icon-minus-sign" style="color:#ff0000"></i> </a></td>  
