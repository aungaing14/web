 ...
 <div id="pop_background2"></div>
        <div id="pop_box2">
            <div id="pop_content2">
                ...
                <form class="form-horizontal" action="teacherupdate.php" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                                <label class="control-label col-sm-3">รหัสผู้ใช้  : </label>
                                <?php
                                    $strSQL = "SELECT * FROM teacher WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                ...
                                ?>
                                    <input class="form-control" readonly required name="txtteacher_id" value='<?php echo $nti['teacher_id'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL = "SELECT a.teacher_id,b.title_name FROM teacher a INNER JOIN title b ON a.title_id=b.title_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                            ...
                            ?>
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtteacher_name" value='<?php echo $nti['teacher_name'];?>'>    
                                <?php }?>
                                </div>
                            <?php
                                    $strSQL = "SELECT * FROM teacher WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                            ...
                            ?>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtteacher_lname" value='<?php echo $nti['teacher_lname'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            ?>
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtteacher_tel" value='<?php echo $nti['teacher_tel'];?>'>    
                                <?php }?>
                                </div>
                            <?php
                                    $strSQL = "SELECT * FROM teacher WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                            ...
                            ?>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input class="form-control" name="txtteacher_email" value='<?php echo $nti['teacher_email'];?>'>    
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3">คณะ : </label>
                                 <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.faculty_name FROM teacher a INNER JOIN faculty b ON a.faculty_id=b.faculty_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                ...
                                ?>
                                    <input type="text" class="form-control" readonly required name="txtfaculty_name" value='<?php echo $nti1['faculty_name'];?>'>
                                <?php }?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.course_name FROM teacher a INNER JOIN course b ON a.course_id=b.course_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <div class="col-sm-5">
                                    ...
                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                    ?>
                                    <input type="text" class="form-control" readonly required name="txtcourse_name" value='<?php echo $nti1['course_name'];?>'>
                                <?php }?>      
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.teacher_id,b.branch_name FROM teacher a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <?php
                                    while ($nti1=mysql_fetch_array($objQuery1)){  
                                    ?>
                                    <input type="text" class="form-control" readonly required name="txtbranch_name" value='<?php echo $nti1['branch_name'];?>'>
                                <?php }?>        
                                </div>
                            </div>
...
<div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT * FROM teacher WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
...
<div class="form-group">
        ...
        <div id="pop_box5">
            <div id="pop_content5">
                ...
                <form name="form1" method="post" action="uploadpicteacher.php?teacher_id=<?php echo $_SESSION['teacher_id'];?>"  enctype="multipart/form-data">
        ...
        <div id="pop_box4">
            <div id="pop_content4"> 
                ...
                <form class="form-horizontal" action="teachereditpass.php?teacher_id=<?php echo $_SESSION['teacher_id'];?>" id="form_submit" method="post">
                        <div id="pop_body">
                            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 panel-body">
                        ...
                        <ul class="list-table" style="padding-left: 5px;">
                            <li>
                                <?php
                            $strSQL = "SELECT * FROM images WHERE id_image = '".$_SESSION['teacher_id']."' ";
                            $objQuery = mysql_query($strSQL) or die(mysql_error());
                                            ...
                                            <div class="form-horizontal"> 
                                                <div class="col-md-12"> 
                                                    <div class="panel-collapse pull-right out">
                                                        <button type="button" class="btn btn-primary btn-lg" id="teacheredit"><i class="icon-pencil"></i> แก้ไขข้อมูล</button>
                                                ...
                                                <div class="col-md-12"> 
                                                        ...
                                                        ?>
                                                            <div class="col-sm-7">
                                                                <?php
                                                                    while ($nti=mysql_fetch_array($objQuery)){  
                                                                ?>
                                                                <label style="font-weight: normal" class="control-label" value='<?php echo $nti['teacher_id'];?>'><?php echo $nti['teacher_id'];?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php
                                                            $strSQL1 = "SELECT a.teacher_id,b.title_name FROM teacher a INNER JOIN title b ON a.title_id=b.title_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                                            $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                                    ...
                                                    <?php
                                                            $strSQL = "SELECT a.teacher_id,b.faculty_id,b.faculty_name FROM teacher a INNER JOIN faculty b ON a.faculty_id=b.faculty_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                                            $objQuery = mysql_query($strSQL);
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php
                                                            $strSQL = "SELECT a.teacher_id,b.course_id,b.course_name FROM teacher a INNER JOIN course b ON a.course_id=b.course_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                                            $objQuery = mysql_query($strSQL);
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <?php
                                                            $strSQL = "SELECT a.teacher_id,b.branch_id,b.branch_name FROM teacher a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE teacher_id = '".$_SESSION['teacher_id']."' ";
                                                            $objQuery = mysql_query($strSQL);
