...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขรายการประเมิน(ทฤษฎี)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
             <form class="form-horizontal" action="subevaeditsave.php" method="post" id="form_submit">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT * FROM subquestion  WHERE subquestion_id=$subquestion_id";
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT a.qfrm_id,b.qfrm_id,b.qfrm_name FROM subquestion a INNER JOIN question_frm b ON a.qfrm_id=b.qfrm_id WHERE subquestion_id=$subquestion_id";
                                    $objQuery = mysql_query($strSQL);
                                ?>
                                <div class="col-sm-4">
                                <?php
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal" onclick='location.replace("adminevalution.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
                    </form>
