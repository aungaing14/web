...
$i='0';
  ...
  <?php
   while ($nti=mysql_fetch_array($objQuery)){  
    $teacherment_id=$nti['teacherment_id'];
    ?>    
...
$strSQL0 = "SELECT * FROM teacherment WHERE teacherment_id=$teacherment_id ";
    ...
    $nti0=mysql_fetch_array($objQuery0);
    $file_name=$nti0['teacherment_name'];

$info = pathinfo( $file_name , PATHINFO_EXTENSION ) ;

if ($info=='jpg') {?>

<a href='downloadment.php?teacherment_name=<?php echo $nti0['teacherment_name'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i class="icon-print" style="color:#00ccff"></i></a>


 <?php }else{   ?> 

   <a href='teacherevamentpdf.php?lession_id=<?php  echo $nti['teacherment_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i class="icon-print" style="color:#00ccff"></i></a>
