...
if ($_SESSION['ses_id']=='') {
    ...
    echo "<meta http-equiv='refresh' content='1;URL=logoutteacher.php'>";
}else{
                    ...
                    <div class="col-lg-12 panel-body">
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="9"><i class="icon-group"></i><strong> นักศึกษาปฏิบัติประสบการณ์วิชาชีพครู</strong></td>
                                    </tr>
                                    <input type="hidden" id="val1" value="0">
                                    <tr style="font-weight:bold">
                                        <td style="width:10%">รหัสนักศึกษา</td>
                                        <td style="width:10%">ชื่อ</td>
                                        <td style="width:10%">สกุล</td>
                                        <td style="width:20%">หลักสูตร</td>
                                        <td style="width:15%">สถานศึกษา</td>
                                        
                                        <td style="width:8%">ประเมิน</td>
                                        <td style="width:7%">บันทึก <br>(การนิเทศ)</td>
                                        <td style="width:9%">สรุปประเมิน (ทฤษฎี)</td>
                                        <td style="width:9%">สรุปประเมิน (ปฏิบัติ)</td>                                   
                                    </tr>
                                    <?php 
                      ...
                      ?> 
                                    <tr>
                                        ...
                                        <td class="text-center" style=" cursor:pointer"><a href='teacherevaadd.php?name=show&studentid=<?php echo $nti['student_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ประเมิน"><i class="icon-edit" style="color:#ffcc00"></i></a></td>
                                        <td class="text-center"><a href='teacherevamentadd.php?eva=teacherevament&student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="บันทึก"><i class="icon-edit" style="color:#ffcc00"></i></a></td>
                                        <td class="text-center"><a href='teacherevamentstdpdf.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i class="icon-print" style="color:#00ccff"></i></a></i></a></td> 
                                        <td class="text-center"><a href='teacherevamentstdlabpdf.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i class="icon-print" style="color:#00ccff"></i></a></i></a></td>                                 
                                    </tr>
                           <?php }?>         
                  ...
                  <table class="table table-hover table-bordered" id="ajax_course_table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:10%;text-align:center">ชั้นเรียน</th>
                        <th style="width:8%;text-align:center">วันที่สอน</th>
                        <th style="width:10%;text-align:center">แผนการสอน</th>
                        <th style="width:10%;text-align:center">คำแนน</th>
                        <th style="width:8%;text-align:center">ประเมิน</th>
                        <th style="width:8%;text-align:center">บันทึก</th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php $strSQL = "SELECT * FROM lession WHERE student_id='$id' ";
                        $objQuery = mysql_query($strSQL);?><?php
                        while ($nti=mysql_fetch_array($objQuery)){  
                        ?>  
                      ...
                      <tr>
                        ...
                        <td class="text-center"><a href='download.php?lession_file=<?php echo $nti['lession_file'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i style="color:#00ccff" class="icon-print"></a></td>
                        <td class="text-center"><?php echo $nti['lession_score'];?></td>
                        <td class="text-center"><a href='teachereva.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ประเมิน"><i class=" icon-edit" style="color:#ffcc00"></i></a></td>
                        <td class="text-center"><a href='teachereva.php?eva=evanmnt&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="เรียกดู"><i class=" icon-search" style="color:#00ccff"></i></a></td>
                        </tr>
