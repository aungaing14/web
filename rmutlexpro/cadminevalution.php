...
<div align="right">
    ...
    <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("cadminevalutionlab.php")'><i class="icon-file-alt"></i> แบบประเมินภาคปฏิบัติ</button>  
</div>                
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แบบประเมิน(ทฤษฎี)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
