                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:60%;text-align:center">ปีการศึกษา</td>
                                    ...
                                    $strSQL = "SELECT * FROM branch ";
                                        ...
                                        <td style="text-align:center;">
                                            <?php
                                                $branch1 ="SELECT * FROM studentsave WHERE branch_id= $branch_id AND year_id=$year_id";
                                        ...
                                        <td style="text-align:center"><a href='reportshowyear.php?branch_id=<?php echo $nti['branch_id'];?>&year_id=<?php echo $year_id;?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
