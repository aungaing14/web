        ...
        <div id="pop_box2">
            <div id="pop_content2">
                <div id="pop_header">
                            ...
                            <i class="icon-edit"></i> เพิ่มรายการ (ทฤษฎี)
                </div>
                <form class="form-horizontal" action="stdteachsub.php" id="form_submit" method="post" enctype="multipart/form-data">
                        <div id="pop_body">
...
<?php   
    $strSQL10 = "SELECT * FROM student WHERE term_id='10' AND year_id='100' AND student_id = '".$_SESSION['student_id']."'";
    $objQuery10 = mysql_query($strSQL10);
    $num10 = mysql_num_rows($objQuery10);
    ...
    if ($num10==0) {?>
               ...
               <div class="row">
                    ...
                    <div class="col-lg-12 panel-body">
                                   ...
                                   <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("stdteachlab.php")'><i class="icon-file-alt"></i> แผนการสอน (ภาคปฏิบัติ)</button> 
                        <hr>
                        </div>
                        <div align="right">
...
<div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="10"><i class="icon-pencil"></i><strong> กำหนดการสอน (ทฤษฎี)</strong></td>
                                    </tr>
                                    ...
                                    <?php $sum='0';
                                    $i='0';
                        $strSQL = "SELECT * FROM lession WHERE year_id='$slterm' AND student_id ='".$_SESSION['student_id']."' ";
                      ...
                      ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center"><a href='lessionupdate.php?lession_id=<?php echo $nti['lession_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class="icon-edit" style="color:#ffcc00"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="fileupload/<?php echo $nti['lession_file'];?>" data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i style="color:#00ccff" class="icon-print"></a></i></td>
                                        <td style="text-align:center"><?php echo $nti['lession_score'];?></td>
                                        
                                        <td style="text-align:center">
<?php
$strSQLa = "SELECT * FROM lessionment WHERE  lessionment_id ='$save' ";
$save1 = mysql_query($strSQLa);
$save2=mysql_fetch_array($save1);
if (!$save2) {?>
   <a href='lessionadd.php?lession_id=<?php echo $nti['lession_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="เพิ่มไฟล์"><i class="icon-plus" style="color:#000"></i></a>
<?php }
else{ ?>

<a href='lessionmentedit.php?lession_id=<?php echo $nti['lession_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class="icon-edit" style="color:#ffcc00"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='lessionpdf.php?lession_id=<?php echo $nti['lession_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="พิมพ์"><i class="icon-print" style="color:#00ccff"></i></a>
...
$a='0';
  $ans='0';
  $strSQL = "SELECT * FROM lessioneva WHERE term_id='$slterm' AND lessioneva_student ='".$_SESSION['student_id']."' ";
    $objQuery = mysql_query($strSQL);
...
$strSQL9 = "SELECT * FROM lessionevatr WHERE lessionevatr_id='$test' ";
...
<div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <?php $suma='0';
                                    $i1='0';
                        $strSQLa = "SELECT * FROM lession WHERE year_id='$slterm' AND student_id ='".$_SESSION['student_id']."' ";
                        $objQuerya = mysql_query($strSQLa);

                        $ntix=mysql_fetch_array($objQuerya);
                        $lid=$ntix['lession_id'];  

$strSQLb = "SELECT * FROM lessionevatr WHERE lessionevatr_student ='".$_SESSION['student_id']."' ";
...
$strSQLb = "SELECT * FROM lessionevatr WHERE lessionevatr_id='$lid' ";
$objQueryb = mysql_query($strSQLb);
...
$an='0';
  ...
  $strSQLn = "SELECT * FROM lessionevatr WHERE term_id='$slterm' AND lessionevatr_student ='".$_SESSION['student_id']."' ";
...
<img  id="img" class="img-thumbnail" src="images/regis.jpg" alt="โยธา" >
