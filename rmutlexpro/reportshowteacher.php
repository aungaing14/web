            ...
            <hr>                      
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                 ...
                                 <label style="font-weight: normal" class="control-label" value='<?php echo $nti['teacher_id'];?>'>อาจารย์ <?php echo $nti['teacher_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['teacher_lname'];?>
...
$strSQLb = "SELECT * FROM student WHERE teacher_id='$teacher_id'";
...
$strSQLa = "SELECT * FROM student WHERE teacher_id='$id1'";
...
else
{
    ...
    $Num_Pages = (int)$Num_Pages;
                                    ...
                                    $i='0';
                                    $strSQL = "SELECT * FROM student WHERE teacher_id='$teacher_id'  ORDER BY student_id ASC LIMIT $Page_Start , $Per_Page ";
                                        $objQuery = mysql_query($strSQL);?>
                                        <?php
                                        while ($nti=mysql_fetch_array($objQuery)){ 
                                        $i=$i+'1'; 
                                        ...
                                        <td style="text-align:center"><a href='reportshowstdteacher.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
