...
<div id="pop_background2"></div>
        <div id="pop_box2">
            <div id="pop_content2">
                <div id="pop_header">
                    <button type="button" class="close" id="close" aria-hidden="Close">×</button>
                        ...
                        <div id="pop_body">
                            ...
                            ?>
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                    <input type="text" class="form-control" name="txttrainer_password" value='<?php echo $nti['trainer_password'];?>'>
                                <?php }?>
                                </div>
                            </div>
                        </div>
                ...
                <div id="aing">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th  style="width:10%;text-align:center">ปีการศึกษา</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align:center"><a href='trainershowstd.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
                        </tr>
                      <?php }?> 
