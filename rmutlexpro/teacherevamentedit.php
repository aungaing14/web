...
<div class="tab-pane active" id="stdpro">
      ...
      <form class="form-horizontal" action="teachermentedit.php?teacherment_id=<?php echo $teacherment_id;?>" method="post" id="form_submit"  enctype="multipart/form-data">
                    ...
                    <div align="left">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control" name="teacherment_date" value='<?php echo $nti['teacherment_date'];?>'>    
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control" readonly required name="subject_name" value='<?php echo $nti['subject_name'];?>'>   
                                ...
                                <div class="col-sm-3">
                                    ...
                                    while ($nti=mysql_fetch_array($objQuery)){  
                                ?>
                                <input class="form-control" readonly required name="lession_name" value='<?php echo $nti['lession_name'];?>'>   
...
<div class="col-sm-8">
                    <textarea type="text" class="form-control" name="teacherevamentsave" style="height: 400;" required="required"><?php echo $nti['teacherment_name'];?></textarea>
                    </div>
    ...
    <?php } ?>
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal" onclick='location.replace("teachereva.php")'><i class="icon-remove"></i> ปิด</button>
                        </div>
                    </form>
