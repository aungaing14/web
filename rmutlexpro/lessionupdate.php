...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขกำหนดการสอน (ทฤษฎี)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="lessionedit.php?lessionid=<?php echo $_GET["lession_id"];?>" id="form_submit" method="post" enctype="multipart/form-data">
 
                            <div class="form-group">
                                <label class="control-label col-sm-3">สัปดาห์ที่ : </label>
                                <?php
                                    $strSQL = "SELECT * FROM lession WHERE lession_id = '$lession_id' ";
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal"  onclick='location.replace("stdteach.php")'><i class="icon-remove"></i> ปิด</button>
                        </div>
                    </form>
