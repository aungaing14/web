                    ...
                    <div align="right">
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="10"><i class=" icon-user"></i><strong> สรุปรายชื่อนักศึกษาปฏิบัติประสบการณ์วิชาชีพครู</strong></td>
                                    </tr>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:15%;text-align:center">แผนก</td>
                                        <td style="width:30%;text-align:center">สถานศึกษา</td>
                                    ...
                                    <?php   
                                    $i='0';
                                    $branch1 ="SELECT * FROM student WHERE branch_id=$branch_id";
                                                $objQuerystd = mysql_query($branch1);
                                                while ($ntia=mysql_fetch_array($objQuerystd)) {
                                                    $brtr=$ntia['trainer_id'];

                                    $strSQL = "SELECT * FROM trainer WHERE trainer_id=$brtr ";
                                        ...
                                        <td style="text-align:left"><?php echo $nti['trainer_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['trainer_lname'];?></td>
                                        
                                        <td style="text-align:center"><?php $educationpart_id=$nti['educationpart_id'];
                                            $strSQL1 = "SELECT * FROM educationpart WHERE educationpart_id=$educationpart_id ";
                                        $objQuery1 = mysql_query($strSQL1);
                                        $nti1=mysql_fetch_array($objQuery1);
                                        echo $nti1['educationpart_name'];
                                        ?></td>
                                        <td style="text-align:center"><?php $education_id=$nti['education_id'];
                                        $strSQL1 = "SELECT * FROM education WHERE education_id=$education_id ";
                                        $objQuery1 = mysql_query($strSQL1);
                                        $nti1=mysql_fetch_array($objQuery1);
                                        echo $nti1['education_name'];

                                        ?></td>
                                
                                        <td style="text-align:center"><a href='reportshowtrainer.php?trainer_id=<?php echo $nti['trainer_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
