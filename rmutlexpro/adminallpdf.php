...
<table width="704" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="200" align="center"><span class="style" style="font-weight: bold;font-size:11pt;"><br>(รายชื่อผู้ดูแลระบบ)</span></td>
...
<?php 
$i='0';
  $strSQL = "SELECT * FROM admin WHERE indentity_id='1' ";
...
$i=$i+'1';
 ...
 <tr align="center" >
    ...
    <td class="style2" width="200" align="left"  style="font-size:10pt;"><?php echo $nti['admin_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['admin_lname'];?></td>
