...
<!-- Tab panes -->
<form class="form-horizontal" action="evastdeditlab.php?studentid=<?php echo $st_row1['student_id'];?>&teacherid=<?php echo $_SESSION['teacher_id'];?>&lessionid=<?php echo $st_row1['lession_id'];?>" id="form_submit" method="post">
<div class="table-responsive">
                 ...
                 <div class="form-group">
                           ...
                           <div class="form-group">
                                ...
                                <?php
                                    $strSQL = "SELECT * FROM lessionevalab WHERE lessioneva_id = '$lession' ";
...
$strSQL1 = "SELECT * FROM lessionevalab WHERE lessioneva_id=$lession ";
$objQuery1 = mysql_query($strSQL1);
while ($nti1=mysql_fetch_array($objQuery1)){ 

$ans=$nti1[$id1];
$strSQL4 = "SELECT * FROM lessionevamentlab WHERE lessionevament_id=$lession ";
