...
$sql_inserta="INSERT INTO `lessionevamenttrainer` (`lessionevamenttrainer_id`,`lessionevamenttrainer_student`,`lessionevamenttrainer_trainer`) VALUES ('".$lessionid."','".$stdid."','".$trainerid."');";
...
$sql_insert1="INSERT INTO `lessionevatr` (`lessionevatr_id`,`term_id`,`lessionevatr_student`,`lessionevatr_date`,`lessionevatr_trainer`) VALUES ('".$lessionid."','".$term."','".$stdid."','$date','".$trainerid."');";
...
$strSQLa = "UPDATE lessionevatr SET q$id = '$save' WHERE lessionevatr_id ='$lessionid'";
...
$sql = "SELECT subquestion_score FROM subquestion WHERE subquestion_id='$id'";
	...
	while($rs1 = mysql_fetch_array($result)){
		...
		$strSQL6 = "UPDATE lessionevatr SET lessionevatr_score = '$ans' WHERE lessionevatr_id ='$lessionid'";
...
foreach( $_POST['question_id'] as $id){
	...
	$strSQLb = "UPDATE lessionevamenttrainer SET q$id = '$ment' WHERE lessionevamenttrainer_id ='$lessionid'";
