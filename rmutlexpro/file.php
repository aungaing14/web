                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold;">
                                        <td style="width:20%;text-align:center">ลำดับ</td>
                                        <td style="width:20%;text-align:center">วันที่</td>
                                        <td style="width:40%;text-align:center">เอกสาร</td>
...
$i=$i+'1';
                                        ...
                                        <td style="text-align:left"><?php echo $nti['file_date'];?></td>
