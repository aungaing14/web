        ...
        <div id="pop_box2">
            <div id="pop_content2">
                <div id="pop_header">
                            ...
                            <i class="icon-edit"></i> เพิ่มเอกสาร
                </div>
                <form class="form-horizontal" action="fileupload.php" id="form_submit" method="post" enctype="multipart/form-data">
                        <div id="pop_body">
                        <div class="form-group">
                                <label class="control-label col-sm-4">วันที่ : </label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="file_date" required="required">    
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-4">ชื่อเอกสาร : </label>
                                <div class="col-sm-4">
                                    <input class="form-control" name="file_name" required="required">    
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 panel-body">
                        <div align="right">
                                ...
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff"><i class="icon-plus"></i> เพิ่มเอกสาร</button>  
                        </div>
                        ...
                        <div class="table-responsive panel-collapse pull out">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="text-align:left" class="success" colspan="10"><i class=" icon-user"></i><strong> เอกสาร</strong></td>
                                    </tr>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:45%;text-align:center">เอกสาร</td>
                                        <td style="width:10%;text-align:center">แก้ไข</td>
                                        <td style="width:10%;text-align:center">ลบ</td>
                                        <td style="width:10%;text-align:center">Download</td>
...
$i=$i+'1';
                                        ...
                                        <td style="text-align:left"><?php echo $nti['file_name'];?></td>
                                        <td style="text-align:center"><a href='fileedit.php?file_id=<?php echo $nti['file_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class=" icon-edit" style="color:#ffcc00"></i></a></td>
                                        <td style="text-align:center"><a href='filedelete.php?file_id=<?php echo $nti['file_id'];?>&file_file=<?php echo $nti['file_file'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ลบ"><i class=" icon-remove" style="color:#000"></i></a></td>
