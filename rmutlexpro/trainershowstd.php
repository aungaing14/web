            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">                  
                ...
                <div align="right">
                                ...
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("trainerstd.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
      ...
      <div><br></div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3">ชั่นปี : </label>
                                 <?php
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.student_id,b.branch_name FROM student a INNER JOIN branch b ON a.branch_id=b.branch_id WHERE student_id='$student_id' ";
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.student_id,b.std_tel FROM student a INNER JOIN stdprofile b ON a.profile_id=b.profile_id WHERE b.student_id='$student_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                <?php
                                    $strSQL1 = "SELECT a.student_id,b.title_id FROM student a INNER JOIN teacher b ON a.teacher_id=b.teacher_id WHERE student_id='$student_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery1)){  
                                ?>
                                <label style="font-weight: normal" class="control-label" value='<?php echo $nti['title_id'];?>'><?php
                                    $strSQL1 = "SELECT a.teacher_id,b.title_name,c.teacher_id FROM teacher a INNER JOIN title b ON a.title_id=b.title_id INNER JOIN student c ON a.teacher_id=c.teacher_id  ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <?php
                                    while ($nti=mysql_fetch_array($objQuery1)){  
                                ?>
                                <?php echo $nti['title_name'];?><?php }?>

                                <?php }?>
                                    </label>  
                                <?php
                                    $strSQL1 = "SELECT a.student_id,b.teacher_name FROM student a INNER JOIN teacher b ON a.teacher_id=b.teacher_id WHERE student_id='$student_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
                                ...
                                <?php
                                    $strSQL1 = "SELECT a.student_id,b.teacher_lname FROM student a INNER JOIN teacher b ON a.teacher_id=b.teacher_id WHERE student_id='$student_id' ";
                                    $objQuery1 = mysql_query($strSQL1) or die(mysql_error());
