                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr style="font-weight:bold;">
                                        ...
                                        <td style="width:30%;text-align:center">สาขาวิชา</td>
                                    ...
                                    $strSQL = "SELECT * FROM student ";
                                        ...
                                        <td style="text-align:center"><a href='reportshowstd.php?student_id=<?php echo $nti['student_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
