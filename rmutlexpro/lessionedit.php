...
$strSQL = "UPDATE lession SET subject_id = '$subject_id',subject_name='$subject_name',lession_name='$lession_name',lession_class='$lession_class',lession_time='$lession_time',lession_week=$lession_week,lession_date='$lession_date' WHERE lession_id = '$lessionid' ";
...
$path_link="fileupload/".$newname;
	...
	if(move_uploaded_file($_FILES['fileupload']['tmp_name'],$path_copy))	{
		$strSQL = "SELECT * FROM lession WHERE lession_id ='$lessionid' ";
...
$strSQL = "UPDATE lession SET lession_file = '$newname' WHERE lession_id = '$lessionid' ";
$objQuery = mysql_query($strSQL);
