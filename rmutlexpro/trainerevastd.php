            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">                  
                ...
                <div align="right">
                                ...
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("trainerevayear1.php?name=show&studentid=<?php echo $st_row['student_id'];?>")'><i class="icon-edit"></i> ประเมินท้ายปีการศึกษา</button>  
                        </div>
  ...
  <table class="table table-bordered" id="ajax_course_table">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th style="width:8%;text-align:center">แก้ไข</th>
                    ...
                    <?php $strSQL = "SELECT * FROM lession WHERE student_id='$id' AND year_id = '$term' ";
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php 
                            ...
                            $strSQL1 = "SELECT * FROM lessionevatr WHERE lessionevatr_id='$lessionid' ";
...
<?php
$strSQL5 = "SELECT * FROM lessionevatr WHERE lessionevatr_id='$lessionid' ";
...
<a href='trainerevastdadd.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ประเมิน"><i class=" icon-edit" style="color:#ffcc00"></i></a>
...
?>
                        ...
                        <td class="text-center">
<?php
$strSQL6 = "SELECT * FROM lessionevatr WHERE lessionevatr_id='$lessionid' ";
...
<a href='trainerevastdedit.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class=" icon-edit" style="color:#ffcc00"></i></a>
  ...
  <table class="table table-bordered" id="ajax_course_table">
                    ...
                    <?php $strSQL = "SELECT * FROM lessionlab WHERE student_id='$id' AND year_id = '$term' ";
                      ...
                      <tr> 
                        ...
                        <td class="text-center"><?php 
                            $lessionid=$nti['lession_id'];
                            $strSQL1 = "SELECT * FROM lessionevatrlab WHERE lessionevatr_id='$lessionid' ";
                            $objQuery1 = mysql_query($strSQL1);?><?php
                            $nti1=mysql_fetch_array($objQuery1);
                            echo $nti1['lessionevatr_score'];  
                        ?></td>
...
<?php
$strSQL5 = "SELECT * FROM lessionevatrlab WHERE lessionevatr_id='$lessionid' ";
$objQuery5 = mysql_query($strSQL5) or die(mysql_error());
$nti5=mysql_fetch_array($objQuery5);
...
<a href='trainerevastdaddlab.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="ประเมิน"><i class=" icon-edit" style="color:#ffcc00"></i></a>
...
?>
                        ...
                        <td class="text-center">
<?php
$strSQL6 = "SELECT * FROM lessionevatrlab WHERE lessionevatr_id='$lessionid' ";
$objQuery6 = mysql_query($strSQL6) or die(mysql_error());
$nti6=mysql_fetch_array($objQuery6);
...
<a href='trainerevastdeditlab.php?eva=evaselect&lession_id=<?php echo $nti['lession_id'];?>'  data-toggle="tooltip" data-placement="top" data-original-title="แก้ไข"><i class=" icon-edit" style="color:#ffcc00"></i></a>
