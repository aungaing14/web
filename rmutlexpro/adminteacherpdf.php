...
ob_start(); 
$teacher_id=addslashes($_GET['teacher_id']);
?>
...
<table width="704" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="200" align="center"><span class="style" style="font-weight: bold;font-size:11pt;"><br>(อาจารย์นิเทศก์)</span></td>
...
<table bordercolor="#666666" width="750" height="78" border="0"  align="center" cellpadding="8" cellspacing="0"  class="style2">
  ...
  <?php
   while ($nti=mysql_fetch_array($objQuery)){  
    ...
    <td class="style2" width="300" align="left" style="font-size:10pt;"><?php echo $nti['teacher_id'];?></td>
    <td class="style2" width="300" align="center" style="font-weight: bold;font-size:10pt;"></td>
       <?php }?> 
    </tr>
   
     <?php 
  $strSQL = "SELECT * FROM teacher WHERE teacher_id = ".$_GET['teacher_id']." ";
    $objQuery = mysql_query($strSQL);?>
  <?php
   while ($nti=mysql_fetch_array($objQuery)){  
    ?>    
  ...
  $strSQL = "SELECT a.title_id,a.teacher_name,a.teacher_lname,b.title_id,b.title_name FROM teacher a INNER JOIN title b ON a.title_id=b.title_id WHERE teacher_id = ".$_GET['teacher_id']." ";
    $objQuery = mysql_query($strSQL);?>
  <?php
   while ($nti=mysql_fetch_array($objQuery)){  
    ?><?php echo $nti['title_name'];?><?php echo $nti['teacher_name'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nti['teacher_lname'];?></td>
...
<?php }?>
 ...
 <?php 
  $strSQL = "SELECT a.branch_id,a.teacher_id,a.course_id,a.faculty_id,b.branch_id,b.branch_name,c.course_id,c.course_name,d.faculty_id,d.faculty_name FROM teacher a INNER JOIN branch b ON a.branch_id=b.branch_id INNER JOIN course c ON a.course_id=c.course_id INNER JOIN faculty d ON a.faculty_id=d.faculty_id WHERE teacher_id = ".$_GET['teacher_id']." ";
    $objQuery = mysql_query($strSQL);?>
  <?php
