...
<div class="tab-pane active" id="stdpro">
          ...
          <div class="form-horizontal">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class=" icon-file-alt"></i> แก้ไขหัวข้อรายการประเมิน(ทฤษฎี)</h3>
              </div>
              <div class="panel-body">                  
                <div class="col-sm-12">
      ...
      <div><br></div>
            <form class="form-horizontal" action="headevaeditsave.php" method="post" id="form_submit">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    $strSQL = "SELECT * FROM question_frm WHERE qfrm_id='$qfrm_id' ";
                        ...
                        <div id="pop_footer">
                            ...
                            <button id="close_modal" type="button" class="btn btn-default" data-dismiss="modal"onclick='location.replace("adminevalution.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  </button>
                        </div>
                    </form>
