                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-teal">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="icon-list-ul"></i> สรุปผลการปฏิบัติประสบการณ์วิชาชีพครู</h3>
                            </div>
                            <div class="panel-body">
                            <div align="right">
                            
                                <button type="button" class="btn btn-primary btn-lg" id="adduser" style="background-color:#80bfff;border-color: #80bfff;; color:#fff" onclick='location.replace("stdabstract.php")'><i class="icon-arrow-left"></i> กลับสู่หน้าหลัก</button>  
                        </div>
                            <form class="form-horizontal" action="abstractstdedit.php?student_id=<?php echo $student_id;?>"  id="form_submit" method="post">
                                <div class="form-horizontal"> 
                                    <div class="col-md-12"> 
                                        <br>
                                        <?php 
                                
                        $strSQL = "SELECT * FROM abstract WHERE abstract_id ='".$_SESSION['student_id']."' ";
                      ...
                      ?>
                                        <div class="col-md-12">
                                            <textarea id="com1" class="form-control" name="abstractname" rows="10"><?php echo $nti['abstract_name'];?></textarea>
                                        </div>
                                        <div class="col-sm-12">
                                            <hr>
                                        </div>
