                                    ...
                                    $strSQL = "SELECT * FROM branch ";
                                        ...
                                        <td style="text-align:center;">
                                            ...
                                            $n='0';
                                                ...
                                                $branch1 ="SELECT * FROM studentsave WHERE branch_id=$branch_id";
                                                $objQuerystd = mysql_query($branch1);
                                                while ($ntia=mysql_fetch_array($objQuerystd)){
                                                    $brtr=$ntia['trainer_id'];
                                                
                                                  
                                                $branch2 ="SELECT * FROM trainer WHERE trainer_id=$brtr";
                                                $objQuerytr = mysql_query($branch2);
                                                
                                                    $ntib=mysql_fetch_array($objQuerytr);
                                                
                                                

                                                

                                                $rowtr=mysql_num_rows($objQuerytr);
                                                $n=$n+$rowtr;
                                            }
                                                    echo $n;
                                        ...
                                        <td style="text-align:center"><a href='reporttrainer.php?branch_id=<?php echo $nti['branch_id'];?>' data-toggle="tooltip" data-placement="top" data-original-title="แสดง"><i class=" icon-search" style="color:#00ccff"></i></a></td>
